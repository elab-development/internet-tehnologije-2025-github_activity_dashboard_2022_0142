...
export default function SearchBox({ onSearch, initialValue }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      ...
      <button 
        type="submit"
        className="px-6 py-2 bg-transparent hover:bg-gray-100 hover:text-black transition-all duration-300 ease-in-out border border-gray-700 rounded-none text-black font-medium"
      >
        Search
      </button>
    </form>
